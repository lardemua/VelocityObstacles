    ...
    public:
        ...
        {   
            ...
            for(Target::Ptr target: targets)
            {
                ...
                out_target.minimumdistance = target->rmin;
                // out_target.radius = target->radius;
                
                target_list.Targets.push_back(out_target);
                // cout << sizeof(target_list.Targets) << endl;
            }
            // cout << "count:"<< count << " stop"<<endl;
            // cout << sizeof(target_list) << endl;
        }
